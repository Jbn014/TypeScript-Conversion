let MYNAME: string = "Jared Nelson".toUpperCase();
...
function displayPosition(jobTitle: string, compName: string, jobDescription: string): void {
...
function displaySkill(skillName: string, coolSkill: boolean): void {
    if (coolSkill == true) {
